		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAPUI5 oData",
									"targetURL": "#sapuidemosapui5odata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapuidemosapui5odata-display": {
								"semanticObject": "sapuidemosapui5odata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.ui.demo.sapui5odata",
									"url": sap.ui.require.toUrl("sap/ui/demo/sapui5odata")
								}
							}
						}
					}
